...
Pooling operations serve two main purposes in convolutional neural networks:

1. **Dimensionality reduction:** By summarizing local regions, pooling reduces spatial dimensions and computational complexity
2. **Translation invariance:** Pooling makes features more robust to small translations in the input

- **Max pooling** selects the maximum value in each local region, preserving the strongest features
- **Average pooling** computes the mean value in each region, providing a smoother representation
